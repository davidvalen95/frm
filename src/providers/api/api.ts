...
export class ApiProvider {
  ...
  public baseUrl: string = ApiProvider.HRM_URL;
    ...
    login(username: string, password: string): Promise<any> {
        ...
        return this.httpClient.get<any>(loginUrl, {headers:header, observe:"response", withCredentials:true, params: body}).toPromise();
    }
    ...
    getEmployeeInformation(id: string, isFnF?: boolean): Promise<EmployeeInformationInterface> {
        ...
        return this.httpClient.get<EmployeeInformationInterface>(ApiProvider.HRM_URL + "s/VisitationRulesList", {withCredentials:true,params: httpParams}).toPromise();
    }
    ...
    getCompanyInformation(outsiderCode: string): Promise<CompanyInformation> {
        ...
        return this.httpClient.get<CompanyInformation>(ApiProvider.HRM_URL + 's/VisitationRulesList', {withCredentials:true, params: httpParams}).toPromise();
    }
    ...
    acknowledge(tid: string, remark: string): Promise<any> {
        ...
        return this.httpClient.get<any>(ApiProvider.HRM_URL + "s/VisitationApplicationAcknowledge_op", {withCredentials:true, params: httpParams}).toPromise()
    }
